package com.example.kbrichta.lab_1_android;
...
public class MainActivity extends AppCompatActivity {
    //captical View is the class
    //second is the name of the parameter, view
    //equivalent of dragging button to view controller in iOS
